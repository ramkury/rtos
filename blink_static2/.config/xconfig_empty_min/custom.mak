...
linker.cmd: package/cfg/empty_min_pe430X.xdl
	$(SED) 's"^\"\(package/cfg/empty_min_pe430Xcfg.cmd\)\"$""\"D:/UnB/Topicos/SO_MSP430/CodeC/rtos/blink_static2/.config/xconfig_empty_min/\1\""' package/cfg/empty_min_pe430X.xdl > $@
