...
empty.xe430X: package/cfg/empty_pe430X.oe430X 
	...
	@$(MSG) lnke430X $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.msp430.elf.MSP430X.rootDir)/bin/cl430 -q -u _c_int00 -z  -o $@ package/cfg/empty_pe430X.oe430X   package/cfg/empty_pe430X.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.msp430.elf.MSP430X.rootDir)/lib/libc.a
